<template>
  <div class="wrapper">
    <parallax class="page-header header-filter" parallax-active="true" :style="headerStyle">
      <div class="container">
        <div class="md-layout">
          ...
          <div class="md-layout">
            <div class="md-layout-item md-size-66 md-small-size-100 mx-auto">
              ...
              <p>
                ...
                <br />
                <br />And now I look and look around and there’s so many Kanyes I've
            ...
            <div class="md-layout-item md-size-66 md-small-size-100 mx-auto">
              <div class="md-layout">
                <div class="md-layout-item md-size-50 md-small-size-100">
                  <div class="blog-tags">
                    Tags:
                    <badge type="primary" class="badge-pill">Photography</badge>
                    <badge type="primary" class="badge-pill">Stories</badge>
                    <badge type="primary" class="badge-pill">Castle</badge>
                  </div>
                </div>
          ...
          <div class="md-layout-item md-size-66 md-small-size-100 mx-auto">
            <div class="comment-area">
              ...
              <div class="comment">
                ...
                <div class="comment-body">
                  ...
                  <div class="comment-footer">
                    <md-button href="javascript:void(0)" class="md-danger md-simple">
                      <md-icon>favorite</md-icon>243
                    </md-button>
                    <md-button href="javascript:void(0)" class="md-success md-simple">
                      <md-icon>reply</md-icon>Reply
                      <md-tooltip md-direction="top">Reply to Comment</md-tooltip>
                    </md-button>
                  </div>
                </div>
              </div>
              ...
              <div class="comment">
                <a class="float-left" href="javascript:void(0)">
                  <div class="avatar">
                    <img class="comment-object" alt="Tim Picture" :src="comment1" />
                  </div>
                </a>
                <div class="comment-body">
                  <h4 class="comment-heading">
                  ...
                  <div class="comment-footer">
                    <md-button href="javascript:void(0)" class="md-simple">
                  ...
                  <div class="comment">
                    <a class="float-left" href="javascript:void(0)">
                      <div class="avatar">
                        <img class="comment-object" alt="64x64" :src="comment3" />
                      </div>
                    </a>
                    <div class="comment-body">
                      <h4 class="comment-heading">
              ...
              <div class="comment comment-post">
                ...
                <div class="comment-body">
                  ...
                  <div class="comment-footer">
                    <md-button href="javascript:void(0)" class="md-success md-round">Post Comment</md-button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="md-layout-item md-size-33 md-small-size-100">
                ...
                >
                  <template slot="cardContent">
                    ...
                    <h4 class="card-title">
                      <a href="javasript:void(0)">Lyft launching cross-platform service this week</a>
                    </h4>
                    <p class="card-description">
              ...
              <div class="md-layout-item md-size-33 md-small-size-100">
                ...
                >
                  <template slot="cardContent">
                    ...
                    <h4 class="card-title">
                      <a href="javasript:void(0)">6 insights into the French Fashion landscape</a>
                    </h4>
                    <p class="card-description">
                      Don't be scared of the truth because we need to restart
                      the human foundation in truth And I love you like Kanye
